	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				...
				<div class="x_content" style="margin-left: 120px;">
					<br>
					<form id="demo-form2" data-parsley-validate=""
						...
						<div class="item form-group bad">
							<label class="control-label col-md-3 col-sm-3 col-xs-12"
								for="name">Parent/Guardian Name <span class="required">*</span>
							</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input name="p2" id="i2" class="form-control col-md-7 col-xs-12"
						...
						<div class="item form-group bad">
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<select id="i3" name="p4" onchange="nationality();" class="form-control col-md-3 col-xs-12">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<label> <input type="radio" class="iradio_flat-green" 
									checked="" value="male" id="i4" name="p5">Male
						...
						<div class="item form-group bad">
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" id="i6" name="p6" placeholder="Date Of Birth
										class="date-picker form-control col-md-7 col-xs-12"
										onkeydown="validatedate();" required="required" />
								</div>
								<div id="s6"></div>
							</div>
						</div>
						...
						<div class="item form-group bad">
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12">Mobile Number<span
									class="required">*</span>
								</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="number" name="p7" id="i7" placeholder="Mobile Number"
										class="date-picker form-control col-md-7 col-xs-12"
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<textarea rows="4"  name="p9" id="i9" class="form-control col-md-7 col-xs-12"
									data-validate-length-range="6" data-validate-words="2" placeholder="Address"
									name="name" placeholder="Address" required="required"
								 onkeydown="validateAddr();">
									</textarea>
							</div>
							<div id="s9"></div>
						</div>
						...
						<div class="item form-group bad">
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<select id="i10" name="p8" class="form-control col-md-3 col-xs-12" onclick="passedYear();">
		...
		<script type="text/javascript">
			var max = new Date().getFullYear(), min = 1990, select = document
