...
<body>
						...
						<div class="col-sm-9 mail_view">
							<div class="inbox-body">
								...
								<div class="sender-info">
									<div class="row">
										<div class="col-md-12">
											<strong>Jon Doe</strong> <span>(<a
												class="__cf_email__" href="/cdn-cgi/l/email-protection"
												data-cfemail="c3a9acadeda7aca683a4aea2aaafeda0acae">[email&#160;protected]</a>
											...
											</span> to <strong>me</strong> <a class="sender-dropdown"><i
	...
	<!-- compose -->
	<div class="compose col-md-6 col-xs-12" style="display: block;">
